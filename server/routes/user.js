...
import { allUsers, delAccount, forgotPassword, getEvents, getMyProfile, login, logOut, onlyUsers, register, resetPassword, updatePassword, updateProfile } from '../controllers/user.js'
